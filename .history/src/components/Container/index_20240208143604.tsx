...
export default function Container(
    ...
    return (
        <>
            ...
            {
                props.fData?.length && props.fData.map((item: IForecastProps, index: number) => {
                    return (
            ...
            {
                props.data?.length && props.date.map((item: IDateProps, index: number) => {
                    return (
                        <div key={index} style={{ margin: '15px' }}>
                            {
            ...
            {
                props.data?.length && props.data.map((item: IWeatherProps, index: number) => {
                    return (
                        <div key={index} style={{ margin: '15px' }}>
