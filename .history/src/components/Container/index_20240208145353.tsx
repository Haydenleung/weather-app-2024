...
export default function Container(
    ...
    return (
        <>
            ...
            {
                typeof props.fData !== "undefined" && props.fData.map((item: IForecastProps, index: number) => {
                    return (
            ...
            {
                typeof props.date !== "undefined" && props.date.map((item: IDateProps, index: number) => {
                    return (
                        <div key={index} style={{ margin: '15px' }}>
                            {
            ...
            {
                typeof props.data !== "undefined" && props.data.map((item: IWeatherProps, index: number) => {
                    return (
                        <div key={index} style={{ margin: '15px' }}>
