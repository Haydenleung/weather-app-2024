...
export default function Container(
    ...
    const formatDate = (tempDate: string) => {
        ...
        var day = new Date(Date.parse(tempDate)).getDay();
        var month = new Date(Date.parse(tempDate)).getMonth();
        month = new Date(Date.parse(tempDate)).toLocaleString('default', { month: 'long' });
